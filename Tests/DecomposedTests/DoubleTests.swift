...
final class DoubleTests: XCTestCase {
  ...
  func testRotation() {
    ...
    testTransformX.rotation = CGQuaternion(angle: .pi / 4.0, axis: CGVector3(normalize(simd_double3(1.0, 0.0, 0.0))))

    var testTransformY = CATransform3DIdentity
    testTransformY.rotation = CGQuaternion(angle: .pi / 4.0, axis: CGVector3(normalize(simd_double3(0.0, 1.0, 0.0))))

    var testTransformZ = CATransform3DIdentity
    testTransformZ.rotation = CGQuaternion(angle: .pi / 4.0, axis: CGVector3(normalize(simd_double3(0.0, 0.0, 1.0))))
    ...
    let testTransformXY = CATransform3DIdentity.rotated(by: CGQuaternion(angle: .pi / 4.0, axis: CGVector3(normalize(simd_double3(x: 1.0, y: 1.0, z: 0.0)))))
  ...
  func testDecompose() {
    ...
    XCTAssertEqual(decomposedRotationTransformQuaternion.rotation, CGQuaternion(angle: .pi / 4.0, axis: CGVector3(normalize(simd_double3(1.0, 1.0, 1.0)))))
  ...
  func testRecompose() {
    ...
    decomposed.rotation = CGQuaternion(angle: .pi / 4.0, axis: CGVector3(normalize(simd_double3(1.0, 0.0, 0.0))))
    ...
    m2.rotation = CGQuaternion(angle: .pi / 4.0, axis: CGVector3(normalize(simd_double3(1.0, 0.0, 0.0))))
  ...
  func testComposition() {
    ...
    let transform2 = CATransform3DIdentity
      ...
      .rotated(by: CGQuaternion(angle: .pi / 4.0, axis: CGVector3(normalize(simd_double3(1.0, 0.0, 0.0)))))
